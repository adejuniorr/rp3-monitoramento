...
export const MonitoringSchedule = () => {
  ...
  return (
    <div data-testid="monitoring-schedule" className="relative rounded-[16px] border border-gray-200 dark:border-gray-600 bg-gray-100 dark:bg-black shadow-md shadow-gray-300 dark:shadow-none">
